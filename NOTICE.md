...
each release. The installer preserves these materials under
`/usr/share/doc/yub-wpanel`. YUB WPanel is provided without warranty; see
`LICENSE` for the complete YUB WPanel license terms.
